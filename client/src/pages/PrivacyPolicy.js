  ...
  return (
    <Prompter>
      <TextContent>
        ...
        <br></br>
        Weebify operates the exampleaddress.com website, which provides the
        SERVICE.This page is used to inform website visitors regarding our
        policies with the collection, use, and disclosure of Personal
        Information if anyone decided to use our Service, the Shop Weebify
        ...
        Terms and Conditions, which is accessible at exampleaddress.com, unless
        ...
        identifiable information, including but not limited to your name, phone
        number, and postal address. The information that we collect will be used
        ...
        used an anonymous unique identifier. These are sent to your browser from
        ...
        us in analyzing how our Service is used. We want to inform our Service
        users that these third parties have access to your Personal Information.
        ...
        guarantee its absolute security. Links to Other Sites Our Service may
